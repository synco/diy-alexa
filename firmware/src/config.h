// WiFi credentials
#define WIFI_SSID "Baabara-2G4"
#define WIFI_PSWD "IknowSynco"
...
#define COMMAND_RECOGNITION_ACCESS_KEY "QROOACAU2JLGNTZ3IU75XWGUN3NGGWXR" // Client "FGXY6BXLB3K2IZW3TITUVKOIGBAPZRM6"
